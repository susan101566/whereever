...
class FurnituresControllerTest < ActionController::TestCase
  ...
  test "should create furniture" do
    assert_difference('Furniture.count') do
      post :create, furniture: { description: @furniture.description, image_url: @furniture.image_url, title: @furniture.title }
    end
  ...
  test "should update furniture" do
    patch :update, id: @furniture, furniture: { description: @furniture.description, image_url: @furniture.image_url, title: @furniture.title }
    assert_redirected_to furniture_path(assigns(:furniture))
  end
